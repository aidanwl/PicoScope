...
class MeasurementWindow:
    ...
    def update(self, samples, sampling_rate):
        ...
        vpp = calculate_vpp(samples)
        vmax = calculate_vmax(samples)
        vmin = calculate_vmin(samples)
        mean = calculate_mean(samples)
        amplitude = calculate_amplitude(samples)
